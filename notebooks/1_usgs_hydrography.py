...
# Dataset. The request is cached on disk; the result is also saved to `data/hydrography/`.
...
# ## What's next
#
# The boundaries are saved to `data/hydrography/`. Notebook **`3_usgs_waterdata`** reads them to
