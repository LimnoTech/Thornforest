...
trends_path = S.data_dir / "conus404" / "conus404_trends_by_huc8.parquet"
...
save_datacube(climatology, S.data_dir / "conus404" / "conus404_climatology_grid.zarr")
...
save_datacube(trend_grid, S.data_dir / "conus404" / "conus404_trends_grid.zarr")
...
# trend tables (parquet/CSV) are saved under `data/conus404/`. Next steps could compare these
# modeled balances against the USGS gauge records discovered in notebook 2, or bring in additional
